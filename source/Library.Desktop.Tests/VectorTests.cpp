...
#pragma warning(pop)
        ...
        TEST_METHOD(IteratorArithmetic) {
            ...
            Assert::AreEqual(vector.end() - vector.begin(), gsl::narrow_cast<typename Vector<Foo>::difference_type>(vector.Size()));
        ...
        TEST_METHOD(ConstIteratorArithmetic) {
            ...
            Assert::AreEqual(vector.cend() - vector.cbegin(), gsl::narrow_cast<typename Vector<Foo>::difference_type>(vector.Size()));
